<template>
  <q-page class="q-pa-sm bg-white">
    <div class="row">
      <totalizacion-de-asistencia class="col-12 col-md-6" />
      <ultimo-mes-asistencia class="col-12 col-md-6" />
    </div>
...
import UltimoMesAsistencia from "components/charts/UltimoMesAsistencia.vue";
import TotalizacionDeAsistencia from "components/charts/TotalizacionDeAsistencia.vue";
